...
<script setup>
  ...
  import { cmsBlocks } from '~/composables/graphql/commerce/queries/blocks/latestBlock.js';

  const { data } = useAsyncQuery(cmsBlocks);
  //import { getLatestProducts } from '~/composables/commerce/products/getLatestProducts.js';

  //const { data: products, pending, error } = getLatestProducts(10); // Fetch 10 latest products
